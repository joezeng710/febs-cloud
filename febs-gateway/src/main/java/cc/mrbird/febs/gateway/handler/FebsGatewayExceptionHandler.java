...
public class FebsGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {
    ...
    public FebsGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties, ErrorProperties errorProperties, ApplicationContext applicationContext) {
    ...
    * */
    ...
    protected Map<String, Object> getErrorAttributes(ServerRequest request, boolean includeStackTrace) {
        ...
        errorAttributes.put("message", judgeException(error));
        return errorAttributes;
    }

    public static String judgeException(Throwable error) {
        String errorMessage;
