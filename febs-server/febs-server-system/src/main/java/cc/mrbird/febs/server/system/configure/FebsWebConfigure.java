...
public class FebsWebConfigure {
    ...
    @Bean
    public PaginationInterceptor paginationIntercepto() {
    ...
    private SecurityScheme securityScheme(FebsSwaggerProperties swagger) {
        ResourceOwnerPasswordCredentialsGrant grantType = new ResourceOwnerPasswordCredentialsGrant(swagger.getGrantUrl());
